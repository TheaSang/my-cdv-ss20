...
function gotData(incomingData){
  ...
  .on("mouseover",function(){
    ...
    d3.select("#introtext").transition().delay(5000).duration(1000).style("top",200+"px");
    ...
    d3.select("#blue").transition().duration(8000).style("opacity",0,3).style("top","-"+480+"px").style("width",800+"px").style("left",480+"px");
    ...
    d3.select(this).transition().delay(5000).duration(1000).attr("cx",380).attr("cy",200).attr("fill","#001a33").attr("r",120);
})
  ;
...
let datagroups1 = generalviz.selectAll(".generaldatagroup").data(incomingData).enter()
   ...
   .attr("class","generaldatagroups")
       ...
       ////////////////////////////
            ...
            .transition()
            .delay(function(d,i){
                return delayScale(timeParseFunction(d.time))/2;
              })
            .duration(800)
...
enterView({
  ...
  enter:function(el){
    ...
    generaltext.transition()
      .delay(function(d,i){return xScale0(d.year)*3})
      .duration(200)
      .attr("opacity",1)
  },
  exit: function(el) {
...
enterView({
  selector:".April",
  enter:function(el){
    d3.select(".questions").transition().text("April Report").style("color","white").style("font-size",40+"px").style("font-family",'AbrilFatface-Regular')
    shortAxis();
    wholefiction();
    xAxisGroup0.transition().attr("opacity",0);
    yAxisGroup0.transition().attr("opacity",0);
    generallines.transition().delay(100).duration(100).attr("opacity",0)
    generalcirclea.transition().delay(100).duration(100).attr("opacity",0)
    generaltext.transition().delay(100).duration(100).attr("opacity",0)
...
{name:"Dobby",time:"1998",reason:"Killed by a knife thrown by Bellatrix Lestrange while saving Harry Potter and his friends from the Death Eaters at Malfoy Manor by apparating to Shell Cottage.",lastline:'"Harry... Potter..."',title:"hahah",notes:"hahahah"},
